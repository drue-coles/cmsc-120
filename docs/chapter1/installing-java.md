...
This section describes how to install the (free) software needed to write and run Java 
programs. Even if you already have the software installed, you need to understand the concepts 
and terminology introduced here.
...
Modern IDEs increasingly incorporate AI-assisted coding, offering suggestions, autocompletions, 
...
Figure 1.3.3: [IntelliJ IDEA](images/figure1.3.3.png)
